...
function dropbox_connect(edy, callback) {
  ...
  Dropbox.AuthDriver.NodeServer.prototype.openBrowser = function(url) {
    // TODO : convert exec to spawn 
    var exec = require('child_process').exec;
    var script = path.resolve(__dirname,  "../../shell/dropbox_login.js");
    var cmd  = 'phantomjs ' + script + ' ' + encodeURIComponent(url) + ":::" + encodeURIComponent(email) + ":::" + encodeURIComponent(password)
